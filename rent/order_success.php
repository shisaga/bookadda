...
$sql = "SELECT * FROM rent_address WHERE user_id = $_SESSION[id] AND address_id = $_SESSION[address_id]";
...
foreach ($_SESSION['order_id'] as $key => $value) {
	...
	$sql = "SELECT * FROM rent_orders WHERE user_id= $_SESSION[id] AND order_id = '$value'";
