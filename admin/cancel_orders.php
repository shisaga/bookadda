...
$sql = "SELECT * FROM orders WHERE refund_status=1 ORDER BY date_of_purchase ASC";
...
while ($row = mysqli_fetch_array($res)) {
    ...
    $sql1 = "SELECT payment_id FROM payment WHERE user_id = '$user_id' AND order_id='$order_id' ";
...
if (isset($_POST['update'])) {
  ...
  $res = mysqli_query($link,"UPDATE orders SET paid='Refunded',refund_status=0 WHERE order_id = '$order_id_update' AND user_id='$user_id'");

  $res1 = mysqli_query($link,"UPDATE payment SET payment_status='Refunded' WHERE order_id = '$order_id_update' AND user_id='$user_id'");
