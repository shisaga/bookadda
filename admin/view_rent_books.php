           ...
           $output .= '
             <tr>
               ...
               <td>
                 ...
                 <!--<button type="button" book_id="'.$row['id'].'" class="btn btn-danger btn-sm remove_book">Remove</button>-->
               </td> 
               </tr>';
       }
     ...
     <table class="table">
      ...
      while ($row = mysqli_fetch_array($result)) {
        ...
        $output .= '
          ...
          <td>'.$row['quantity'].'</td>
          <td>
            <!--<button type="button" id="'.$row['id'].'" class="btn btn-info btn-sm update_book" data-toggle="modal" data-target="#UpdateBookModal">Update</button>-->
            <!--<button type="button" book_id="'.$row['id'].'" class="btn btn-danger btn-sm remove_book">Remove</button>-->
          </td>
          </tr>';
      }
